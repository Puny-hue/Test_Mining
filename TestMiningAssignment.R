...
karbonn_aura = read.csv("C:/EXCELR/ASSIGNMENTS/TextMining/karbonn_aura.csv",header = TRUE)
...
cannon_camera = read.csv("C:/EXCELR/ASSIGNMENTS/TextMining/canon_camera.csv",header = TRUE)
View(cannon_camera)
str(cannon_camera)
names(cannon_camera)
...
canon_camera = read.csv("C:/EXCELR/ASSIGNMENTS/TextMining/canon_camera.csv",header = TRUE)
...
frozen <- read.csv("C:/EXCELR/ASSIGNMENTS/TextMining/Frozen.csv")
View(frozen)
str(frozen)
summary(frozen)
...
forzen = read.csv("C:/EXCELR/ASSIGNMENTS/TextMining/Frozen.csv",header = TRUE)
